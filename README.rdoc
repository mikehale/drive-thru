...
You'll need to enter your password once to setup the public key. After that take a 5 minute break while drive-thru handles your order.
  ...
  # Edit Rakefile with your server specific information
  rake initialize_host
  # adds your public key to root user, configures DNS, installs chef-solo, rsyncs your cookbooks and runs chef-solo
